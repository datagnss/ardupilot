...
BUILD_OPTIONS = [
    ...
    Feature('GPS Drivers', 'NMEA_GPS', 'AP_GPS_NMEA_ENABLED', 'Enable NMEA GPS', 1, None),
    Feature('GPS Drivers', 'NMEA_UNICORE', 'AP_GPS_NMEA_UNICORE_ENABLED', 'Enable NMEA Unicore GPS', 0, "NMEA_GPS"),
    Feature('GPS Drivers', 'NMEA_ALLYSTAR', 'AP_GPS_NMEA_ALLYSTAR_ENABLED', 'Enable NMEA AllyStar GPS', 1, "NMEA_GPS"),
